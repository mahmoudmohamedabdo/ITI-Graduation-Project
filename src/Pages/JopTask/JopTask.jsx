    ...
    return (
        <div className="container px-4 mx-auto w-sm-full">
            ...
            <div className="bg-white p-6 rounded shadow-sm m-5">
                ...
                <span className='font-normal my-5 mb-6'>Create a simple todo application using React with the ability to add, edit, and delete tasks.</span>
                ...
                <div className='flex justify-between items-center my-2'>
                    ...
                    <span className=''> <button className='btn bg-[#16A34A] text-white rounded-lg px-8 py-2'>View Details</button></span>
                </div>
            </div>
        </div>
    )
